 ...
 */
anotherCapital = stateCapitals["Pennsylvania"]
if let capital = anotherCapital {
    print("The capital of Pennsylvania is \(capital)")
} else {
    print("I don't know Pennsylvania's capital")
 ...
 */
let state = "New York"
print("The capital of \(state) is \(stateCapitals[state]!)")
/*: question11
 ...
 */
var bandDictionary : [String : Array] = ["Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                  "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
                  "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
                  "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
/*: question12
 ...
 */
let bandName = "Pixies"
print("The members of the band \(bandName) are \(bandDictionary[bandName]!)")